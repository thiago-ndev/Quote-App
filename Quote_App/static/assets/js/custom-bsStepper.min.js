...
document.addEventListener('DOMContentLoaded', function () {
     ...
     */
     ...
     stepperDefault = new Stepper(stepperWizardDefault, {
         animation: true
     })
     document.getElementById('defaultStep-one').classList.remove('dstepper-none')
     document.getElementById('defaultStep-one').classList.add('active')
     ...
     v_stepperDefault = new Stepper(v_stepperWizardDefault, {
         animation: true
     })
